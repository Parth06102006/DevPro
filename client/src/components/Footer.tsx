    ...
    <footer className="py-10 px-4 sm:px-6 lg:px-8 font-inter relative overflow-hidden ">
      <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10">
        <div className="mb-6 flex items-center justify-center">
          <img src="/logo.png" alt="" className="w-13 rounded-2xl h-13 object-cover mr-4"/>
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-500 mt-4 ml-4">
          &copy; {new Date().getFullYear()} Made By <span><img src="/signature.svg" alt="Parth Garg signature" className="inline w-30"/>
</span>
        </p>
      </div>
    </footer>
